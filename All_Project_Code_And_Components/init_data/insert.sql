...
insert into reviews (review_title, username, review, rating) values ('Review of Harry Potter and the Sorcerer''s Stone', 'BookLover', 'Harry Potter and the Sorcerer''s Stone captivates with its magical world, compelling characters, and enchanting narrative. J.K. Rowling''s debut introduces readers to an unforgettable journey of wizardry and friendship.', 4.9);
insert into reviews (review_title, username, review, rating) values ('Review of Huckleberry Finn', 'BookLover', 'Huckleberry Finn is a timeless classic, navigating the Mississippi River with Huck and Jim. Mark Twain''s vivid storytelling and social commentary make it an enduring masterpiece of American literature.', 3.8);
