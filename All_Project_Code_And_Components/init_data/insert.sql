...
insert into reviews (review_title, username, review, rating) values ('Review of Huckleberry Finn', 'BookLover', 'Huckleberry Finn is a timeless classic, navigating the Mississippi River with Huck and Jim. Mark Twain''s vivid storytelling and social commentary make it an enduring masterpiece of American literature.', 7.8);
insert into reviews (review_title, username, review, rating) values ('Review of Romeo and Juliet', 'BookLover', 'Romeo and Juliet, a timeless classic by William Shakespeare, beautifully captures the essence of tragic love, poignant sacrifice, and feuding families, creating an enduring masterpiece of literature.', 8.9);
insert into reviews (review_title, username, review, rating) values ('Review of Dracula', 'BookLover', 'Dracula by Bram Stoker is a timeless masterpiece, weaving suspense and horror into a captivating narrative. Stoker''s gothic masterpiece introduces the iconic Count Dracula, leaving readers spellbound with its chilling atmosphere.', 7.3);
