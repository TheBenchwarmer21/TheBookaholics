...
insert into reviews (review_title, username, review, rating) values ('Review of Harry Potter and the Sorcerer''s Stone', 'BookLover', 'Harry Potter and the Sorcerer''s Stone captivates with its magical world, compelling characters, and enchanting narrative. J.K. Rowling''s debut introduces readers to an unforgettable journey of wizardry and friendship.', 4.3);
insert into reviews (review_title, username, review, rating) values ('Review of Huckleberry Finn', 'BookLover', 'Huckleberry Finn is a timeless classic, navigating the Mississippi River with Huck and Jim. Mark Twain''s vivid storytelling and social commentary make it an enduring masterpiece of American literature.', 4.4);
insert into reviews (review_title, username, review, rating) values ('Review of Romeo and Juliet', 'BookLover', 'Romeo and Juliet, a timeless classic by William Shakespeare, beautifully captures the essence of tragic love, poignant sacrifice, and feuding families, creating an enduring masterpiece of literature.', 4.9);
insert into reviews (review_title, username, review, rating) values ('Review of Dracula', 'BookLover', 'Dracula by Bram Stoker is a timeless masterpiece, weaving suspense and horror into a captivating narrative. Stoker''s gothic masterpiece introduces the iconic Count Dracula, leaving readers spellbound with its chilling atmosphere.', 3.8);
insert into reviews (review_title, username, review, rating) values ('My thoughts on Huckleberry Finn', 'LunaExplorer', 'I thought ''Huckleberry Finn'' offered a nuanced exploration of societal norms and racial dynamics in 19th-century America. The timeless themes and complexities of the central characters resonated with me, showcasing Mark Twain''s insightful commentary on the era.', 4.7);
...
insert into reviews (review_title, username, review, rating) values ('My favorite book of all time', 'EmberSeeker', 'I LOVED this book and it means SO much to me. The story is always so unexpected every single time and I can''t imagine where I would be without reading it', 5);
